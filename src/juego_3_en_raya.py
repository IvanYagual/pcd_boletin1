...
def test_generar_tablero():
    mov_jugador_1 = {}
    mov_jugadore_2 = {}
    movimientos_jugadores = [mov_jugador_1, mov_jugadore_2]
    n = 3
...
Metódo que comprueba que un movimiento de un jugadore es válido

    * x: fila donde el jugador quiere colocar la ficha.

    * y: columna donde el jugador quiere colocar la ficha.

    * movimientos_jugadores: listado con las celdas ocupadas por el otro jugador.
...
while casillas_libres > 0:
    ...
    if movimiento_valido(x, y, movimientos_otro_jugador):
        ...
        frequency = 2000 # Set Frequence To 2500 Hertz
